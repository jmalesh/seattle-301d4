...
articleView.setTeasers = function() {
  ...
  // TODO: Add a delegated event handler to reveal all the hidden elements,
  //       when the .read-on link is clicked. You can go ahead and hide the
  //       "Read On" link once it has been clicked. Be sure to prevent the default
  //       link-click action! Ideally, we should attach this as just 1 event handler
  //       on the #articles section, and let it process any .read-on clicks that
  //       happen within child nodes.
};
